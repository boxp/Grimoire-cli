...
(defn listener 
  "ユーザーストリームリスナーを作成, twitter:Twitterインスタンス, nodes:HomeTimeLineに表示するObservableList, mention-nodes:Mentionsに表示するObservableList"
  [twitter nodes mention-nodes]
  (let [screenname (. twitter getScreenName)]
